...
def model_fn(features, labels, mode):
    #input and reshape
    input_layer = tf.reshape(features['x'],[-1,8,8,29])
    #conv1
    ...
    #conv4
    conv3 = tf.layers.conv2d(inputs=relu2, filters=1, kernel_regularizer=tf.contrib.layers.l2_regularizer(0.0001),kernel_size=[1, 1],
...
data_x = data_1[:,0:1856]
data_y = data_1[:,1856:1860]
...
test_x = data_late[:,0:1856]
test_y = data_late[:,1856:1860]
