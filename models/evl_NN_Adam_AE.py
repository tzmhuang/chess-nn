...
Get graph/model:
    gcloud compute copy-files nn-instance1:/home/huangtom2/DNN/evl_Adam_AE/ ./
Get model:
    gcloud compute copy-files nn-instance1:/home/huangtom2/DNN/model/... ./
Reset:
    rm -r ./DNN/evl_Adam_AE
'''
...
logs_path = "./DNN/evl_Adam_AE/graph"
saver_dir = "./DNN/evl_Adam_AE/model/evl_Adam_AE"
...
with tf.name_scope("layer_1"):
    with tf.name_scope("weights_1"):
        W_1 = weight_variable(1541,1000,"W_1")
...
with tf.name_scope("layer_2"):
    with tf.name_scope("weights_2"):
        W_2 = weight_variable(1000,1000,"W_2")
...
with tf.name_scope("layer_3"):
    with tf.name_scope("weights_3"):
        W_3 = weight_variable(1000,750,"W_3")
