...
y_ = tf.placeholder(tf.float32, name = "flag",shape = [None,1])
...
with tf.Session() as sess:
    ...
    for i in range(epochs):
        err,_ = sess.run([cost,train_step], feed_dict={x: data_x_500,y_: data_y_500})
