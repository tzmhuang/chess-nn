...
Get graph/model:
    gcloud compute copy-files nn-instance1:/home/huangtom2/DNN/evl_NN_3_1_3_GD/ ./
Get model:
...
logs_path = "./DNN/evl_NN_3_1_3_GD/graph"
saver_dir = "./DNN/evl_NN_3_1_3_GD/model/evl_NN_3_1_3_GD"
