'''
Name: evl_NN_3_min_rand
Date: 13,Apr,2018
Train on: Google VM
Purpose:
        - using smaller batch size: 256
...
Get graph/model:
    gcloud compute copy-files nn-instance1:/home/huangtom2/DNN/evl_NN_3_1_2_GD/ ./
Get model:
...
logs_path = "./DNN/evl_NN_3_min_rand/graph"
saver_dir = "./DNN/evl_NN_3_min_rand/model/evl_NN_3_min_rand"
