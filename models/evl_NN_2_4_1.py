...
Get graph/model:
    gcloud compute copy-files nn-instance1:/home/huangtom2/DNN/evl_NN_2_4_1/ ./
Get model:
...
logs_path = "./DNN/evl_NN_2_4_1/graph"
saver_dir = "./DNN/evl_NN_2_4_1/model/evl_NN_2_4_1"
