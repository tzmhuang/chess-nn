...
data = train_piece_num

tmp1 = data[:,0:1].repeat(64,1).reshape(-1,1)
tmp2 = data[:,1:2].repeat(64,1).reshape(-1,1)
tmp3 = data[:,2:3].repeat(64,1).reshape(-1,1)
tmp4 = data[:,3:4].repeat(64,1).reshape(-1,1)
tmp5 = data[:,4:5].repeat(64,1).reshape(-1,1)
tmp6 = data[:,5:6].repeat(64,1).reshape(-1,1)
tmp7 = data[:,6:7].repeat(64,1).reshape(-1,1)
tmp8 = data[:,7:8].repeat(64,1).reshape(-1,1)
tmp9 = data[:,8:9].repeat(64,1).reshape(-1,1)
tmp10 = data[:,9:10].repeat(64,1).reshape(-1,1)
tmp11 = data[:,10:11].repeat(64,1).reshape(-1,1)
tmp12 = data[:,11:12].repeat(64,1).reshape(-1,1)

temp = np.concatenate((tmp1,tmp2,tmp3,tmp4,tmp5,tmp6,tmp7,tmp8,tmp9,tmp10,tmp11,tmp12),1)
