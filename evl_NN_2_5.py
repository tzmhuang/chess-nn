...
Purpose:
        based on evl_NN_2_4
        Correction potential bug in rand_batch() [line 253],
        data_size > actual training datasize
        causing some sample to be empty array,
        potentially causing PROBLEM

Config:
        Epoch: 5
        batch_size: 10000
        Initialization: rand_normal [mean = 0, std = 0.001]
...
#config
logs_path = "./chess_nn/evl_NN_2_5/graph"
saver_dir = "./chess_nn/evl_NN_2_5/model/evl_NN_2_5"
# logs_path = "./DNN/evl_NN_2_4/graph"
# saver_dir = "./DNN/evl_NN_2_4/model/evl_NN_2_4"
