...
Get graph:
    gcloud compute copy-files nn-instance1:/home/huangtom2/DNN/evl_NN_2_3/ ./
Get model:
...
#config
logs_path = "./chess_nn/evl_NN_2_3_1/graph"
saver_dir = "./chess_nn/evl_NN_2_3_1/model/evl_NN_2_3_1"
# logs_path = "./DNN/evl_NN_2_3/graph"
# saver_dir = "./DNN/evl_NN_2_3/model/evl_NN_2_3"
batch_size = 10000
training_epochs = 5
...
def weight_variable(r_num, c_num, name):
    initial = tf.truncated_normal([r_num,c_num], stddev = 0.001)
