...
tf.app.flags.DEFINE_string('model_dir',"./DNN/evl_conv_2/",'dir of model stored' )
...
def model_fn(features, labels, mode):
    ...
    #conv4
    conv4 = tf.layers.conv2d(inputs=relu3, filters=1, kernel_size=[1, 1],
    ...
    dense_1 = tf.layers.dense(inputs=flattern, units=64, name='DENSE_1')
...
with tf.device('/gpu:0'):
    evl_conv_temp = tf.estimator.Estimator(
        model_fn = model_fn, model_dir = "./DNN/evl_conv_2/")
