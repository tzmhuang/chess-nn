...
Get graph/model:
    gcloud compute copy-files nn-instance1:/home/huangtom2/DNN/evl_NN_2_4_mid/ ./
Get model:
    gcloud compute copy-files nn-instance1:/home/huangtom2/DNN/model/... ./
Reset:
    rm ./DNN/graph/evl_NN_2_4_mid/*
'''
...
logs_path = "./DNN/evl_NN_2_4_mid/graph"
saver_dir = "./DNN/evl_NN_2_4_mid/model/evl_NN_2_4_mid"
...
train_h = h5py.File("./DNN/train_h_mid.h5")
test_h = h5py.File("./DNN/test_h_mid.h5")
