from Desktop.DNN.minimax_lookup import *

meta_dir = "./chess_nn/evl_NN_2_4/model/evl_NN_2_4-0.meta"
...
sess = tf.Session()
imported_meta.restore(sess, tf.train.latest_checkpoint('./chess_nn/evl_NN_2_4/model/'))
...
def evaluate(in_data):
    ...
    v = sess.run(tf.log(Y+epsilon), feed_dict={x:in_data})
    return -v[0,0]+v[0,1]
